...
export const SONGS: Song[] = [
  ...
  // The White Lounge（FC ツアー 2023-12〜2024-03）で披露された 2 曲。音源は『The White Lounge in CINEMA - Original Soundtrack』（2024-09-23）
  s("the-white-lounge", "The White Lounge", 2024, "single", "mid"),
  s("tsukimashiteha", "ツキマシテハ", 2024, "single", "mid"),
  s("bitter-vacances", "ビターバカンス", 2024, "single", "up"),
  s("apollodorus", "アポロドロス", 2024, "single", "up"),
  s("columbus", "コロンブス", 2024, "single", "up"),
  ...
  s("stardom", "Stardom", 2020, "single", "mid"),
  ...
  s("a-priori", "ア・プリオリ", 2018, "single", "mid"),
